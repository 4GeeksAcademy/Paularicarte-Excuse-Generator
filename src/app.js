...
window.onload = () => {
  ...
  document.querySelector("#btn").addEventListener("click", () => {
    let excuseData = generateExcuse();
    document.querySelector("#the-excuse").innerHTML = excuseData.excuse;
    document.querySelector("#the-img").src = excuseData.imagen;
  });
...
let generateExcuse = () => {
  let img = [
    ...
    "src/assets/img/tortuga.avif",
    "src/assets/img/dino.gif",
    "src/assets/img/gato.jpg",
    "src/assets/img/Wind.jpg",
    "src/assets/img/ordenador.avif",
  ...
  // let imgIndex = imageIndexMap[who[whoIndex]];
  // if (imgIndex === undefined) {
  //   imgIndex = 0; // Índice de imagen predeterminado
  // }
  // let imgSource = img[imgIndex];
